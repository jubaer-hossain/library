...
namespace library.librarian
{
    public partial class issue_books : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                enrno.Items.Add(dr["email"].ToString());
            }
            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        SqlCommand cmd2 = con.CreateCommand();
                        cmd2.CommandType = CommandType.Text;
                        cmd2.CommandText = "select * from customer where email='" + enrno.SelectedItem.ToString() + "'";
                        cmd2.ExecuteNonQuery();
                        DataTable dt2 = new DataTable();
                        SqlDataAdapter da2 = new SqlDataAdapter(cmd2);
                        da2.Fill(dt2);
                        ...
                        cmd4.CommandText = "update books set availability_qty=availability_qty-1 where books_isbn='" + isbn.SelectedItem.ToString() + "'";
        ...
        protected void isbn_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dr2 in dt2.Rows)
            {
                i1.ImageUrl = dr2["book_image"].ToString();
                booksname.Text = dr2["books_title"].ToString();
                instock.Text = dr2["availability_qty"].ToString();
            }
        }
    }
}
<%@ Page Title="" Language="C#" MasterPageFile="~/librarian/librarian.Master" AutoEventWireup="true" CodeBehind="new_issue.aspx.cs" Inherits="library.librarian.issue_books" %>
                    ...
                    <div class="card-body">
                        ...
                        <form action="" id="fo1" runat="server" method="post" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                <label for="" class="control-label mb-1">Customer's email</label>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <asp:Image ID="i1" runat="server" Height="300" Width="150" /><br />
